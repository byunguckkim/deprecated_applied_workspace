...
# source: simian/public/proto/map/map_junction.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='simian/public/proto/map/map_junction.proto',
  package='simian_public.hdmap',
  syntax='proto2',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n*simian/public/proto/map/map_junction.proto\x12\x13simian_public.hdmap\x1a*simian/public/proto/map/map_geometry.proto\x1a$simian/public/proto/map/map_id.proto\"p\n\x08Junction\x12#\n\x02id\x18\x01 \x01(\x0b\x32\x17.simian_public.hdmap.Id\x12-\n\x07polygon\x18\x02 \x01(\x0b\x32\x1c.simian_public.hdmap.PolygonJ\x04\x08\x03\x10\x04R\noverlap_id'
  ,
...
_JUNCTION = _descriptor.Descriptor(
  name='Junction',
  full_name='simian_public.hdmap.Junction',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='simian_public.hdmap.Junction.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='polygon', full_name='simian_public.hdmap.Junction.polygon', index=1,
...
_JUNCTION.fields_by_name['id'].message_type = simian_dot_public_dot_proto_dot_map_dot_map__id__pb2._ID
_JUNCTION.fields_by_name['polygon'].message_type = simian_dot_public_dot_proto_dot_map_dot_map__geometry__pb2._POLYGON
...
Junction = _reflection.GeneratedProtocolMessageType('Junction', (_message.Message,), {
  ...
  '__module__' : 'simian.public.proto.map.map_junction_pb2'
  # @@protoc_insertion_point(class_scope:simian_public.hdmap.Junction)
  })
